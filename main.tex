...
\begin{proposition}
    ...
    \begin{enumerate}[(i)]
        ...
        \item 如果 $B$ 是余纤维性对象, $h\colon X \rightarrow Y$ 是平凡纤维化或者纤维性对象之间的弱等价, 那么 $h$ 诱导同构
        \[
        \operatorname{Hom}_\mathcal{C}(B,X) / \overset{l}{\sim} \xrightarrow{\cong} \operatorname{Hom}_\mathcal{C}(B,Y) / \overset{l}{\sim}
        \]
        对偶地, 如果 $X$ 是纤维性对象, $h \colon A \rightarrow B$ 是平凡余纤维化或者纤维性对象之间的弱等价, 那么 $h$ 诱导同构
        \[
